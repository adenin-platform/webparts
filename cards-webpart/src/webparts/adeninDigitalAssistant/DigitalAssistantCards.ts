...
import styles from './DigitalAssistantCards.module.scss';
import * as strings from 'DigitalAssistantCardsStrings';
...
export interface IDigitalAssistantCardsProps {
  tenantURL: string;
  componentCDN: string;
...
export default class DigitalAssistantCards extends BaseClientSideWebPart<IDigitalAssistantCardsProps> {
